...
n=int(input())
print("enter wining score")
w=int(input())
from collections import defaultdict
 
letter_codes = [ord(ch) for ch in 'WASPRQwasprq']
...
class GameField(object):
	def __init__(self, height=n, width=n, win=2048):
		self.height = height
		self.width = width
		self.win_value = win
		self.score = 0
	...
	def draw(self, screen):
		help_string1 = '(W)Up (S)Down (A)Left (P)Right'
